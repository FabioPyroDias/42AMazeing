...
- [*Maze Generation*](https://weblog.jamisbuck.org/2011/2/7/maze-generation-algorithm-recap) - Visual explanation of maze algorithms

### Algorithms

- [*Prim's algorithm*](https://see-algorithms.com/graph/BFS)

- [*Kruskal's algorithm](https://see-algorithms.com/graph/Kruskals)

- [*Depth First Search (DFS)*](https://see-algorithms.com/graph/DFS)

- [*Breadth First Search (BFS)*](https://see-algorithms.com/graph/BFS)
